<a href='<?php echo HTTP_PATH;?>mastertables/vessels/add' class="btn btn-info" title="Add New Vessel" style="cursor:pointer; float:left;" data-toggle="modal" data-target="#modalDialog">Add Vessel</a>
<div class="panel-body">
	<table data-toggle="table" id="vessels-table" class="table table-striped table-hover" data-url="<?php echo HTTP_PATH."mastertables/vessels/json"; ?>" data-cache="false" data-side-pagination="server" data-pagination="true" data-show-columns="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true">
		<thead>
			<tr>
				...
				<th data-field="name" data-align="center" data-sortable="false" data-visible="true">Name</th>
				...
				<th data-field="year_built" data-align="center" data-sortable="false" data-visible="true">Year Built</th>
				<th data-field="builder" data-align="center" data-sortable="false" data-visible="true">Builder</th>
				...
				<th data-field="year_last_drydocked" data-align="center" data-sortable="false" data-visible="true">Year Last Drydocked</th>
				<th data-field="place_last_drydocked" data-align="center" data-sortable="false" data-visible="true">Place Last Drydocked</th>
