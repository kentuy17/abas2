<?php
	$formaction= HTTP_PATH."mastertables/vessels/insert";
	...
	if (isset($existing)){
		$formaction= HTTP_PATH."mastertables/vessels/update/".$existing['id'];
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<form action = "<?php echo $formaction; ?>" method='POST' id='mastertables_vessel_form' role='form' enctype='multipart/form-data'>
