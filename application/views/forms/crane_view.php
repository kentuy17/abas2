                     ...
                     <div class="x_panel">
                        ...
                        <div class="x_content">
                           <br>
						    ...
						    <a class="like" href="<?php echo HTTP_PATH ?>forms/crane_form" data-toggle="modal" data-target="#modalDialog" title="New Item" data-keyboard="false" data-backdrop="static">
								<button type="button" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-plus"></i> Add New Crane</button>
							</a>
							<hr />
                              ...
                              <tbody>
							   <?php 
								if( !empty($craneList) ) {
                                    ...
                                    ?>
                                 <tr>
                                    <td><?php  echo $crane['name'] ?></td>
                                    <td><?php  echo $crane['make'] ?></td>
									<td><?php  echo $crane['model_year'] ?></td>
                                    <td><?php  echo $crane['aquisition_cost'] ?></td>
                                    <td><?php  echo $crane['serial_no'] ?></td>
                                    <td><?php  echo $crane['chasis_no'] ?></td>
									<td><?php  echo date('F j, Y', strtotime($crane['date_acquired'])) ?></td>
									<td><?php  echo $crane['status'] ?></td>
									<td align="center">
                                       <a class="like" href="<?php echo HTTP_PATH ?>forms/crane_form/<?php echo $crane['id'] ?>" data-toggle="modal" data-target="#modalDialog" data-keyboard="false" data-backdrop="static">
