<form class="form-horizontal" role="form" action="<?php echo HTTP_PATH.'forms/add_port'; ?>" method="post" style="height: 400px;">
											...
											<div class="panel-body" role="tab">
												<div style="width:200px; margin-left:80px; float:left; margin-top: 16px;">
													...
													<div class="form-group">
														<label>Code:</label>
														<div>															
                                                            <input class="form-control input-sm ui-autocomplete-input" type="text" name="code" class="form-control abas_Formcontrol" value="" required>
														</div>
													</div>
													<div class="form-group">
														<label>Region:</label>
														<div>
															<input class="form-control input-sm ui-autocomplete-input" type="text" name="region" class="form-control" value="" required>
														</div>
													</div>
													<div class="form-group">
														<label>Address:</label>
														<div><input type="text" name="address" class="form-control input-sm ui-autocomplete-input" value="" required />
														</div>
													</div>		
												</div>
											</div>
