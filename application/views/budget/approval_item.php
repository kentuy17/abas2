...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h2 class="panel-title">For Final Approval
...
<div class="panel-body">
	<table data-toggle="table" id="budget-table" class="table table-bordered table-striped table-hover" data-url="<?php echo HTTP_PATH."manager/verify_item_data/".$id; ?>" data-cache="false" data-side-pagination="server" data-pagination="true" data-show-columns="true" data-page-list="[5, 10, 20, 50, 100, 200, 500, 1000, 2500, 5000, 10000]" data-search="true" data-strict-search="false">
		<thead>
			<tr>
				...
				<th data-field="format_prev_budget" data-align="right" data-visible="true" data-sortable="true" data-filter-control="select" data-filter-strict-search="false">Previous Budget</th>
	...
	<a href="<?=HTTP_PATH.'manager/approve/reject/'.$id?>"><button class="btn btn-danger btn-sm pull-right">Reject</button></a>
	<a href="<?=HTTP_PATH.'manager/approve/approved/'.$id?>"><button class="btn btn-success btn-sm pull-right">Approve</button></a>

	<script>

		function view(value, row, index) {
			return [
				'<a class="btn btn-info btn-xs btn-block force-pageload" href="<?php echo HTTP_PATH.'manager/purchase_requests/view'; ?>/'+ row['id'] +'">Delete</a>'
			].join('');
		}
		$(function () {
