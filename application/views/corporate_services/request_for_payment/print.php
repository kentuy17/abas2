...
$content .=			'<tr>
					...
					<tr>
						<td style="text-align:left">Date:<u>'.date('j F Y',strtotime($request[0]['created_on'])).'</u></td>
						<td style="text-align:left">Date:<u>'.date('j F Y',strtotime($request[0]['verified_on'])).'</u></td>
						<td style="text-align:left">Date:<u>'.date('j F Y',strtotime($request[0]['approved_on'])).'</u></td>
					</tr>
				</table>
			</div>';
