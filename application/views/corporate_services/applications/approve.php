	...
	<div class="panel panel-default">
		<div class="panel-body panel-primary">
			<ul class="nav nav-tabs">
				<li class="active nav-danger">
					<a href="<?=HTTP_PATH?>Corporate_Services/approval/leave">
						Leave <?=$leave_count > 0 ? "($leave_count)" : ""?>
					</a>
				</li>
				<li class="nav-warning">
					<a href="<?=HTTP_PATH?>Corporate_Services/approval/overtime">
			...
			<div class="tab-content">
				<div id="leave-approval" class="tab-pane fade in active" >
					<form method="POST" action="<?=HTTP_PATH.'Corporate_Services/approval/filter?form=leave'?>">
						<div class="panel panel-primary" style="margin-top: 10px;">
							<div class="panel-heading">
								<h3 class="panel-title">Leave Applications</h3>
							</div>
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<a href="<?=HTTP_PATH.'Corporate_Services/approval/leave'?>" class="btn btn-dark">Refresh</a>
								</div>
							</div>
						</div>
					</form>
					<div class="panel panel-primary" style="padding: 20px;margin-top: 20px">
						<table data-toggle="table" id="leave-table" class="table table-bordered table-striped table-hover" data-cache="false" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200, 500, 1000, 2500, 5000, 10000]" data-search="true">
							<?php //$this->Mmm->debug($leave) ?>
							<thead>
								<tr>
									<th>Date Filed</th>
									<th>Employee Name</th>
							...
							<?php foreach ($leave as $ctr => $row) { ?>
								<tr>
									...
									<td><?=$row['status']?></td>
									<td>
										<a href="<?=HTTP_PATH.'Corporate_Services/approval/view/'.$row['id']?>" class="btn btn-info btn-xs btn-block" data-toggle="modal" data-target="#modalDialogNorm" data-backdrop="static">View</a>
									</td>
								</tr>
							<?php } ?>
							</tbody>
