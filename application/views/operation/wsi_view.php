          ...
          <div class="row tile_count" style="height:50px; color:#FF6600">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"> 
              	<a class="like" href="<?php echo HTTP_PATH ?>operation/wsi_form" data-toggle="modal" data-target="#modalDialogSemiWide" title="Add WSI">
              	<button type="button"><i class="fa fa-check"></i> Add WSI</button>
              	</a>
              </span>
              <div class="count"></div>
                  ...
                  <div class="x_content">
                    <br>
                        ...
                        <table data-toggle="table" id="invent-table" class="table table-striped table-hover table-responsive" data-cache="false" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-page-size="5"  data-search="true" style="font-size:12px">
										<thead>
											<tr align="center">
												<th width="3%"  data-field="id" data-align="center" data-sortable="true" >WSI #</th>
												...
												<th  width="33%"  data-sortable="true">Issued From / Issued To</th>
                                                <th  width="10%"   data-sortable="true">Bags</th>											
												<th  width="10%"   data-sortable="true">Weight</th>		
											...
											<tbody>
												...
												?>
                                                <tr>
													<td  align="center"><?php  echo $trans['wsi_no']; ?></td>                                                    
													...
													<td align="center" style="font-size:12px; color:#00CC33">
                                                    	<a class="like" href="<?php echo HTTP_PATH ?>operation/wsi_form/<?php  echo $trans['id']; ?>" data-toggle="modal" data-target="#modalDialogWide" title="WSR Form">
