         ...
         <form class="form-horizontal form-label-left" name="wsrForm" method="post" action="<?php echo HTTP_PATH.'operation/addTransaction'; ?>">
                    ...
                    <div style="float:left">
                        ...
                        <div style="width:500px">	
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Issued From:</label>
                            <div class="col-md-9 col-sm-9 col-xs-9">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Issued To:</label>
                            <div class="col-md-9 col-sm-9 col-xs-9">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9">
                              <input type="text" class="form-control" name="waybill_no" id="waybill_no" value="<?php echo $waybill_no ?>" >
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9">
                              <input type="text" class="form-control" name="wsi_no" id="wsi_no" value="<?php echo $wsi_no ?>" >
                 ...
                 <div style="float:right; margin-right:10px">
                        ...
                        <div style="width:570px">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Stock Condition:</label>
                            <div class="col-md-9 col-sm-9 col-xs-9">
                              <input type="text" class="form-control" name="stock_condition" id="stock_condition" value="<?php echo $stock_condition ?>" >
                      ...
                      <input type="hidden" class="form-control" name="type" id="type" value="WSR">
