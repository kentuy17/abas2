...
<script type="text/javascript">
		...
		function submitMe(){
			...
			var sp = document.getElementById('service_provider').value;
			...
			if(sp ==''){
				...
				document.getElementById('service_provider').focus();
				return false;
			}else if(r == ''){
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<form class="form-horizontal form-label-left" name="wsrForm" method="post" action="<?php echo HTTP_PATH.'operation/addRequestPayment'; ?>">
                    ...
                    <div style="float:left">
                        ...
                        <div style="width:400px">	
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Select Billing For:</label>
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Service Provider:</label>
                            <div class="col-md-9 col-sm-9 col-xs-9">
                             
                              <select class="form-control" name="service_provider" id="service_provider" required="required">
                              		<option></option>
                 ...
                 <div class="form-group" style="width:810px;">
                 	<div style="float:left; width:200px;"  >
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-9">
                              	...
                              	<input type="text" name="rate" id="rate" class="form-control" style="width:100px;"
                                		onKeyPress="
                                        	if(event.keyCode == 13){                                            	
                                               if(this.value == ''){
                                		...
                                		onKeyPress="
                                        	if(event.keyCode == 13){
                                                ...
                                                if(w !== ''){
                                                	...
                                                	alert('Please enter Waybill, WSR or WSI Number.');
