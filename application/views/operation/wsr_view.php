          ...
          <div class="row tile_count" style="height:50px; color:#FF6600">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"> 
              	<a class="like" href="<?php echo HTTP_PATH ?>operation/wsr_form" data-toggle="modal" data-target="#modalDialogWide" title="Add Wsr">
              	<button type="button"><i class="fa fa-check"></i> Add WSR</button>
              	</a>
              </span>
              <div class="count"></div>
                  ...
                  <div class="x_content">
                    <br>
                        ...
                        <table data-toggle="table" id="invent-table" class="table table-striped table-hover table-responsive" data-cache="false" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-page-size="5"  data-search="true" style="font-size:12px">
										<thead>
											<tr align="center">
												<th width="3%"  data-field="id" data-align="center" data-sortable="true" >WSR #</th>
                                                <th width="12%"  data-align="center" data-sortable="true">Issue Date</th>
                                                <th width="12%"  data-align="center" data-sortable="true">Reference #</th>
												<th  width="33%"  data-sortable="true">From / To</th>
                                                <th  width="18%"   data-sortable="true">Bags / Gross Weight</th>
											...
											<tbody>
                                            	<?php 
													...
													if($issued_from){ $from = $issued_from->name; }
													
													$delivered_to = $this->Operation_model->getTruckingLocation($trans['to_location']);
													if($delivered_to){ $delivered_to = $delivered_to->name; }
													
													$region = $this->Abas->getRegion($trans['region']);
												?>
                                                <tr>
													<td  align="center"><?php  echo $trans['wsr_no']; ?></td>                                                    
                                                    <td align="left"><?php echo date('F j, Y',strtotime($trans['issue_date'])); ?></td>
													<td  align="left"><?php echo $trans['reference_no']; ?></td>
                                                    <td  align="left"><?php echo $from.' - '.$delivered_to;?></td>
													<td align="left"><?php echo $trans['bags']; ?></td>
                                                    <td align="left"><?php echo number_format($trans['gross_weight'],0).' kgs'; ?></td>
																									
                                                    <td align="center"><?php echo $trans['status']; ?></td>                                                    
													<td align="center" style="font-size:12px; color:#00CC33">
                                                    	<a class="like" href="<?php echo HTTP_PATH ?>operation/wsr_form/<?php  echo $trans['id']; ?>" data-toggle="modal" data-target="#modalDialogWide" title="WSR Form">
