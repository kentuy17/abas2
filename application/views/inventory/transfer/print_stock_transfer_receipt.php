...
$content =  '<style type="text/css">
            ...
            <div>
                <table border="0" cellspacing="5">
                   ...
                   <tr>
                    <td align="left" colspan="7"><b>Requesting Warehouse: </b>'.$MTR[0]['to_location'].'</td>
...
$content .='<div><br><br><table>
                <tr>
                    <td align="left" colspan="4"><b>Prepared by:</b></td>
                    <td align="left" colspan="2"></td>
                    <td align="left" colspan="2"></td>
                    <td align="left" colspan="4"><b>Noted by:</b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="center" colspan="4"><b>Signature over printed name</b></td>
                ...
                <tr>
                    <td align="left" colspan="4"><b>Released by:</b></td>
                    <td align="left" colspan="2"></td>
                    <td align="left" colspan="2"></td>
                    <td align="left" colspan="4"><b>Received by:</b></td>
                </tr>
                <tr>
                    <td align="center" colspan="4"><br><br><br>_____________________________<br></td>
                    <td align="left" colspan="2"></td>
...
$data['title']          =   "Stock Transfer Receipt - Control No." . $MTR[0]['control_number'];
