...
$content =  '<style type="text/css">
            ...
            <div>
                <table border="0" cellspacing="5">
                    <tr>
                        <td colspan="9" class="btx">MTR No.</td>
                        <td colspan="1" class="btx" align="left">'.$MTR[0]['control_number'].'</td>
                    </tr>
                    <tr>
                        <td colspan="10"><h2>MATERIAL TRANSFER REQUEST<br></h2></td>
                    </tr> 
                   <tr>
                    <td align="left" colspan="7"><b>Warehouse Location: </b>'.$MTR[0]['to_location'].'</td>
                    <td align="right" colspan="3"><b>Date: </b>'.date('m-d-Y', strtotime($MTR[0]['transfer_date'])).'</td>
                    </tr>
                    <tr>
                         <td align="left" colspan="6"><b>Issuing Warehouse: </b>'.$MTR[0]['from_location'].'</td>
...
$content .='<div align="left" class="btx">Remarks:'.$MTR[0]['remark'].'</div>';

$content .='<div><br><br><table>
                <tr>
                    <td align="left" colspan="4"><b>Requested by:</b></td>
                    <td align="left" colspan="2"></td>
                    <td align="left" colspan="2"></td>
                    <td align="left" colspan="4"><b>Approved by:</b></td>
                </tr>
                <tr>
                    <td align="center" colspan="4"><br><br><br>_____________________________<br></td>
                    <td align="left" colspan="2"></td>
                    <td align="left" colspan="2"></td>
                    <td align="center" colspan="4"><br><br><br>_____________________________<br></td>
                </tr>
                <tr>
                    <td align="center" colspan="4"><b>Warehouse Custodian</b></td>
                    <td align="left" colspan="2"><br></td>
                    <td align="left" colspan="2"><br></td>
                    <td align="center" colspan="4"><b>Warehouse Supervisor</b></td>
                </tr>
                <tr>
...
$data['title']          =   "Material Transfer Request - Control No." . $MTR[0]['control_number'];
$copy_for1 = "(Requesting Warehouse Copy)<hr>";
$copy_for2 = "(Issuing Warehouse Copy)<hr>";
$copy_for3 = "(Accounting Copy)<hr>";
$data['content'][0]     =   $content.$copy_for1;
$data['content'][1]     =   $content.$copy_for2;
$data['content'][2]     =   $content.$copy_for3;
$data['control_number']     =   "Transaction Code No." . $MTR[0]['id'];
