 ...
 $content2 =  '<style type="text/css">
            ...
            <div>
                <table border="0" cellspacing="5">
                    ...
                    <tr>
                        <td align="left" colspan="7"><b><u>Department/Vessel: '.$vessel_issuance->name.'</u></b></td>
                        <td align="right" colspan="3"><b><u>Date Issued: '.date('m-d-Y', strtotime($summary_issuance[0]['issue_date'])).'</u></b></td>
                    </tr>';
if($summary_receiving){
     $content2 .= '<tr>
                        <td align="left" colspan="4"><b>Requisition No.: </b><u>'.$summary_receiving[0]['control_number'].' (TS Code No. '.$summary_receiving[0]['id'].')</u></td>
                    </tr>
                </table><br>';
}
