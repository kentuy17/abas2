            ...
            <div>
                <table border="0" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td colspan="4" align="left"><b><u>'.$MSIS[0]['issued_to'].'</u></b></td>
                        <td colspan="2" align="right">Date:</td>
                        <td colspan="2" align="left"><b><u>'.date('m-d-Y', strtotime($MSIS[0]['issue_date'])).'</u></b></td>
                    </tr>
                     <tr>
                        <td align="left" colspan="10"><br>We would like to request permission to bring out from the <b><u>'. $_SESSION['abas_login']['user_location'].' warehouse</u></b></td>
                        <td align="left"></td>
                    </tr>
                    <tr>
                        <td align="left" colspan="10">the following materials and supplies for <b><u>'.$vessel->name.'</u></b></td>
                        <td align="left"></td>
                    </tr>
                </table><br>';
...
foreach($MSIS_details as $detail){
  ...
  $content .='<tr>
                ...
                <td width="50%" align="left">'.$itemInfo[0]['description'].', '.$itemInfo[0]['brand']." ".$itemInfo[0]['particular'].'</td>
