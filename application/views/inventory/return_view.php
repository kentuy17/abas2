...
<table><tr><td>
							<?php if($this->Abas->checkPermissions("inventory|inventory_transfer",false)){ ?>
                             	<a class="like" href="<?php echo HTTP_PATH ?>inventory/transfer_form" data-toggle="modal" data-target="#modalDialogNorm" title="New Item">
                                    <button type="button" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-plus"></i> Return Inventory</button>
                                </a>
								<!---
...
<table id="datatable-responsive" style="margin-top:10px;font-size:11px" class="table table-striped table-bordered dt-responsive nowrap jambo_table" cellspacing="0" width="100%" >
										<thead>
											<tr style="background-color:#993300">
                                            	<th colspan="9">INVENTORY RETURN</th>
                                            </tr>
                                            <tr align="center">
                                                ...
                                                <th  width="10%"   data-sortable="true">Supplier</th>												
                                                <th width="10%" class="col-sm-2" >From Location</th>
											...
											<?php
												...
												foreach($inventory_return as $inventory){
											...
											?>
												<tr>
                                                    ...
                                                    <td align="center"><?php echo date('F j, Y', strtotime($inventory['created_date'])); ?></td>
													<td align="center"><?php echo $inventory['id']; ?></td>
                                                    <td align="left"><?php echo $company->name; ?></td>
                                                    <td align="left"><?php echo $inventory['supplier_id']; ?></td>
                                                    <td  align="left"><?php echo $inventory['from_location']; ?></td>							
                                                    <td align="left"><?php echo $inventory['remark']; ?></td>                                                   
													<td>
                                                    <a class="like" href="<?php echo HTTP_PATH.'inventory/print_return/'.$inventory['id']; ?>" title="View Inventory Transfer" data-toggle="modal" data-target="#modalDialogNorm">
