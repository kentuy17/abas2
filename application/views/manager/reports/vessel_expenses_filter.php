<div class="panel panel-primary">
	...
	<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		Filter: Vessel Expenses
	</div>
</div>
		<div class="modal-body">
			<form action="<?php echo HTTP_PATH .'manager/vessel_expenses_report/result'?>" method="POST" id="filter_form">
				...
				<div class="col-xs-12 col-sm-6">
				<label for="type">Type of Expenses:* </label>
