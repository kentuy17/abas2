...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form action="<?php echo HTTP_PATH."accounting/financial_statement/report"; ?>" method="POST" onsubmit="javascript: checkform();" enctype="multipart/form-data" name="fs_form" id="fs_form">
			<?php echo $this->Mmm->createCSRF(); ?>
			<div class="col-lg-12 col-md-12 col-sm-12">
				<label id="report_type" class="control-label">Report type</label>
				<select class="form-control" id="report_type" name="report_type">
					<option value="trial balance">Trial Balance</option>
					<option value="statement of financial position">Statement of Financial Position</option>
					<option value="statement of income">Statement of Income</option>
				</select>
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12">
