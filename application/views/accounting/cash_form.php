...
<form class="form-horizontal" role="form" name="bankForm" id="bankForm" action="<?php echo HTTP_PATH.'accounting/add_cash'; ?>" method="post" style="height: 400px;">
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
				...
				$( "#autocomplete" ).autocomplete({
					source: "<?php echo HTTP_PATH; ?>accounting/deparment_data",
					minLength: 2,
