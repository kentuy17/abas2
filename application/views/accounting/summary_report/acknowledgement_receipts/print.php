<?php 
		...
		$content .= "<br><h1>Acknowledgement Receipts Summary Report</h1><br>";
						...
						if(isset($receipts)){
							foreach($receipts as $row){
								$content .= "<tr>";
									...
									$content .= "<td style=\"width:40px\">".$row->ar_num."</td>";
		...
		$data['orientation']		=	"L";
		$data['pagetype']			=	"legal";
		$data['title']				=	"Acknowledgement Receipts Summary Report";
