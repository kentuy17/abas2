...
<div>
	...
	<div class="xx_title">
		<h2>Official Receipts Summary Report</h2>
	</div>

		<a id="filterDate" href="<?php echo '../filter_summary_report/official_receipts'; ?>" class="glyphicon-th-user btn btn-success pull-center exclude-pageload" data-toggle="modal" data-target="#modalDialog" title="Filter">Filter</a>
		<a id="reset" href="<?php echo HTTP_PATH."accounting/summary_report/official_receipts"; ?>" class="glyphicon-th-user btn btn-dark pull-center force-pageload" title="Refresh">Refresh</a>
		<a id="print" href="<?php echo '../print_summary_report/official_receipts/?date_from='. $date_from . '&date_to=' . $date_to .'&company='. $company?>" class="glyphicon-th-user btn btn-info pull-center exclude-pageload" title="Print" target="_blank">Print</a>
		...
		<table data-toggle="table" id="summary" data-show-columns="true" data-search="true" data-cache="false" data-pagination="true" data-filter-control="false" data-filter-strict-search="false" data-page-list="[5,10,20,50,100,1000,10000]" data-export-data-type="all" data-show-export="true" data-export-types="['excel']">
			...
			<thead>
				<tr>
					...
					<th data-filter-control='input' data-sortable='true' data-align='center'>OR No.</th>
