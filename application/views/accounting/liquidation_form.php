		...
		<div class="panel panel-primary">
			<div class="panel-heading">
                 ...
                 <span style="float:right; margin-right:10px; margin-top:-15px;">
					<input class="btn btn-default btn-sm"  value="Cancel" data-dismiss="modal" style="width:100px; margin-left:10px; margin-top:10px" onclick="javascript:window.location = '<?php echo site_url("finance/accounts_view##cash_advance") ?>';">
				</span>
