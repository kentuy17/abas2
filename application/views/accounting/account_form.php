...
<div class="panel-group" id="content">
	<div class="panel panel-default">
		<div class="panel-heading">
			<span class="pull-left; margin-left:20px; margin-top:-10px">
            ...
            <span class="pull-right; margin-right:20px; margin-top:-5px">
					...
					<div class="panel panel-default" style="font-size:12px">
						...
						<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
							<div class="panel-body" style="background:#B0C6DF">
								...
								<form class="form-horizontal" role="form" id="expenseForm" name="expenseForm"  action="<?php echo HTTP_PATH.'Accounting/addExpense'; ?>" method="post" enctype='multipart/form-data'>
								<!--- waybill activity --->
									...
									<div class="container">
										<div class="panel panel-default" style="font-size:12px; width:550px; height:445px">
											...
											<div class="panel-body" role="tab" >
												...
												<span class="pull-right; margin-right:10px; margin-top:0px">
