...
<div id="voucherPrint" >
	...
	<table style="width:800px; " >
                ...
                <tr id="sub-title">
                	<td align="left"><strong>Payee: <?php echo $supplier['name'] ?></strong></td>
                    <td align="left"></td>
                    <td align="right"><strong style="color:#FF0000">Voucher No: <?php echo strtoupper($voucher[0]['voucher_number']) ?></strong></td>
                    
                </tr>
                <tr id="sub-title">
                	<td align="left"><strong>Address: <?php echo $supplier['address']  ?></strong></td>
                    <td align="left"></td>
                    <td align="right"><strong>Date: <?php echo date('F j, Y')  ?></strong></td>
                    
                </tr>
                <tr id="sub-title">
                	<td align="left"><strong>TIN: <?php echo $supplier['tin']  ?></strong></td>
                    <td align="left"></td>
                                                ...
                                                <tr>
                                                  ...
                                                  <td class="a-left " style="font-size:16px; font-weight:600" align="center" colspan="2">												
                                                    ...
                                                    <table>
                                                  	...
                                                  	<table width="70%" bgcolor="#CCCCCC" cellpadding="1" cellspacing="1" border="1px">
...
<div style="position:absolute; margin-top:185px; margin-left:155px; font-size:13px"><?php echo $supplier['name'];?></div>
<div style="position:absolute; margin-top:220px; margin-left:155px; font-size:13px"><?php echo $supplier['address'];?></div>
