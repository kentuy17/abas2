                  ...
                  <div class="x_content">
                    ...
                    <div  class="tab-content">
                    	...
                    	<table id="datatable-responsive" style="margin-top:10px" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td align="center">
                                            ...
                                            <a class="like" href="<?php echo HTTP_PATH ?>accounting/vouchers/create/<?php echo $v['id'] ?>/purchase" data-toggle="modal" data-target="#modalDialog" title="Create Voucher">
                                                <button type="button" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-pencil"></i></button>
                                            </a>
                                         	<?php 	} ?>

                                            <?php if($vstat == 'For voucher printing' || $vstat == 'For releasing'){ ?>
                                            <a class="like" href="<?php echo HTTP_PATH ?>accounting/print_voucher/<?php echo $v['voucher_id']?>" data-toggle="modal" data-target="#modalDialog" title="Print">
                            ...
                            <div id="cash_advance" class="tab-pane fade <?php echo $v_in_active ?> table-responsive" style="display:none">
                            		<br>
                                 <hr />
