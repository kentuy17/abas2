<h2 id="glyphicons-glyphs">Accounts Receivables - Posted</h2><br>
		
		<a href="<?php echo HTTP_PATH."accounting/listview/accounts_receivables/posted"; ?>" class="btn btn-dark force-pageload">Refresh</a>
