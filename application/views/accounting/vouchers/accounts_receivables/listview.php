<h2 id="glyphicons-glyphs">Accounts Receivables</h2><br>
		
		<!--<a href="<?php //echo HTTP_PATH."accounting/listview/accounts_receivables"; ?>" class="btn btn-dark">Clear Filter</a>-->
		...
		<div role="tabpanel" data-example-id="togglable-tabs">
	        ...
	        <div id="tab_contents" class="tab-content">
	         	...
	         	<div role="tabpanel" class="tab-pane fade" id="tab_posted" aria-labelledby="tab_posted">
					...
					<table data-toggle="table" id="data-table3" class="table table-bordered table-striped table-hover" data-url="<?php echo HTTP_PATH.'accounting/load/ac_transactions/statement_of_accounts/1';?>" data-cache="false" data-side-pagination="server" data-pagination="true" data-show-columns="true" data-sort-name="created_on" data-sort-order="desc" data-page-list="[5, 10, 20, 50, 100, 200, 500]" data-search="true">
						<thead>
							<tr>
								<th data-field="transaction_id" data-align="center" data-visible="false" data-sortable="true" data-filter-control="input">Transaction Code</th>
								...
								<th data-field="reconciled" data-align="left" data-visible="true" data-sortable="true" data-filter-control="select">Reconciled?</th>
...
<script>
	...
	function processAR(value, row, index) {
		return [
			'<a class="btn btn-info btn-xs btn-block" href="<?php echo HTTP_PATH.'accounting/add/accounts_receivables/';?>'+row['id']+'" data-toggle="modal" data-target="#modalDialog" data-backdrop="static">Process</a> ',
		].join('');
	}

	function viewAR(value, row, index) {
		return [
			'<a class="btn btn-info btn-xs btn-block" href="<?php echo HTTP_PATH.'accounting/view/accounts_receivables/';?>'+row['reference_id']+'/'+row['transaction_id']+'" data-toggle="modal" data-target="#modalDialog" data-backdrop="static">View</a> ',
		].join('');
	}
