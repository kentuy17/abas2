<h2 id="glyphicons-glyphs">Payroll Entries- For Clearing</h2><br>

		
	<table data-toggle="table" id="data-table" class="table table-bordered table-striped table-hover" data-url="<?php echo HTTP_PATH.'accounting/payroll_entries/load/for_clearing';?>" data-cache="false" data-side-pagination="server" data-pagination="true" data-show-columns="true" data-sort-name="payroll_date" data-sort-order="desc" data-page-list="[5, 10, 20, 50, 100, 200, 500]" data-search="true" data-filter-control='true'>
		<thead>
			<tr>
				...
				<th data-field="operate" data-formatter="processPayrollEntries" data-events="operateEvents"  data-align="center" data-align="center">Manage</th>
			</tr>
		</thead>
	</table>
...
<script>
	...
	function processPayrollEntries(value, row, index) {
		return [
			'<a class="btn btn-info btn-xs btn-block" href="<?php echo HTTP_PATH.'accounting/payroll_entries/add/for_clearing/';?>'+row['id']+'" data-toggle="modal" data-target="#modalDialog" data-backdrop="static">Process</a> ',
		].join('');
	}
