<h2 id="glyphicons-glyphs">Accounts Collection - For Clearing</h2><br>
		
		<a href="<?php echo HTTP_PATH."accounting/listview/accounts_collection/for_clearing"; ?>" class="btn btn-dark force-pageload">Refresh</a>
...
<script>
	...
	function processAC(value, row, index) {
		return [
			'<a class="btn btn-info btn-xs btn-block force-pageload" href="<?php echo HTTP_PATH.'accounting/add/accounts_collection/';?>'+row['id']+'" data-toggle="modal" data-target="#modalDialog" data-backdrop="static">Process</a> ',
		].join('');
	}
