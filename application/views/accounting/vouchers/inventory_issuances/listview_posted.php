<h2 id="glyphicons-glyphs">Inventory Issuances - Posted</h2><br>

		
	<table data-toggle="table" id="data-table" class="table table-bordered table-striped table-hover" data-url="<?php echo HTTP_PATH.'accounting/inventory_issuances/load/posted';?>" data-cache="false" data-side-pagination="server" data-pagination="true" data-show-columns="true" data-sort-name="issue_date" data-sort-order="desc" data-page-list="[5, 10, 20, 50, 100, 200, 500,1000,2000,3000,5000,10000]" data-search="true" data-filter-control='true'>
		<thead>
			<tr>
				...
				<th data-field="posted_on" data-align="left" data-visible="true" data-sortable="false">Posted On</th>

				<th data-field="remark" data-align="left" data-visible="false" data-sortable="false">Remark</th>

				<th data-field="operate" data-formatter="viewInventoryIssuance" data-events="operateEvents"  data-align="center" data-align="center">Manage</th>
			</tr>
		</thead>
	</table>
...
<script>
	...
	function viewInventoryIssuance(value, row, index) {
		return [
			'<a class="btn btn-info btn-xs btn-block" href="<?php echo HTTP_PATH.'accounting/inventory_issuances/view/posted/';?>'+row['id']+'/'+row['transaction_id']+'" data-toggle="modal" data-target="#modalDialog" data-backdrop="static">View</a> ',
		].join('');
	}
