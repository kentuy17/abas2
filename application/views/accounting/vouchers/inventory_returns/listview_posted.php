<h2 id="glyphicons-glyphs">Inventory Returns - Posted</h2><br>

		
	<table data-toggle="table" id="data-table" class="table table-bordered table-striped table-hover" data-url="<?php echo HTTP_PATH.'accounting/inventory_returns/load/posted';?>" data-cache="false" data-side-pagination="server" data-pagination="true" data-show-columns="true" data-sort-name="return_date" data-sort-order="desc" data-page-list="[5, 10, 20, 50, 100, 200, 500,1000,2000,3000,5000,10000]" data-search="true" data-filter-control='true'>
		<thead>
			<tr>
				<th data-field="id" data-align="center" data-visible="false" data-sortable="true" data-filter-control="input">Transaction Code</th>

				<th data-field="return_date" data-align="center" data-visible="false" data-sortable="true" data-filter-control="input">Issuance Date</th>
...
<script>
	...
	function viewInventoryReturns(value, row, index) {
		return [
			'<a class="btn btn-info btn-xs btn-block" href="<?php echo HTTP_PATH.'accounting/inventory_returns/view/posted/';?>'+row['id']+'/'+row['transaction_id']+'" data-toggle="modal" data-target="#modalDialog" data-backdrop="static">View</a> ',
		].join('');
	}
