<?php 
	...
	$bank	= 	$this->Finance_model->getBank($voucher[0]['bank_id']);
	//var_dump($delivery_summary);exit;
?>
...
<div class="panel-heading">
   ...
   <h4 class="modal-title" id="myModalLabel"><strong>Purchase Funding</strong></h4>
</div>
<div class="modal-body">
   <div style="margin-bottom:20px">
      <div style="font-size:14px">
         <div style="float:left; width:400px; margin-top:10px">
            <div><strong>Voucher ID.: <?php echo $delivery_summary[0]['voucher_id'] ?></strong></div>
         ...
         <div style="float:right; width:300px; margin-top:10px">
            ...
            <div><strong>PO No.: <?php echo $delivery_summary[0]['po_no'] ?></strong></div>
         </div>
      </div>
   </div>
   <br /><br /><br />
   ...
   <div>
      <form class="form-horizontal" role="form" name="vForm" id="vForm" action="<?php echo HTTP_PATH.'finance/purchase_funding_approval'; ?>" method="post">
         <?php echo $this->Mmm->createCSRF() ?>
         <input type="hidden" name="voucher_id" id="voucher_id" value="<?php echo $delivery_summary[0]['voucher_id'] ?>">
      </form>
      <div style="float:right; margin-right:30px">
         <span style="margin-right:80px;">
         <strong>Bank: <?php echo $bank[0]['name']; ?></strong><br />
         <strong>Available Fund: <?php echo $bank[0]['curbal']; ?></strong>
         </span>
