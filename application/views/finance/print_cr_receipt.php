    ...
    <div id="items">
    	<div id="table">
        	<table style="width:800px; " >
            	<tr>
                	<td colspan="3" align="left">(RECIPIENT'S COPY)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <!--- cash request table -->
                    		<div width="50%"><strong>CASH REQUEST RECEIPT</strong></div>
                            <div width="50%">
                            	<span style="margin-right:10px; margin-top:-30px; float:right">Receipt No.: <?php echo $cash_advance[0]['id'] ?></span>
                            </div>
					<br>                        
