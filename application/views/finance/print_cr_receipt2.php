    ...
    <div id="items">
    	<div id="table">
        	<table style="width:800px; " >
            	<tr>
                	<td colspan="3" align="left">(CASHIER'S COPY)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <span style="margin-right:10px; float:right">Receipt No.: <?php echo $cash_advance[0]['id'] ?></span>
                    </td>
                </tr>
                ...
                <tr>
                	<td align="left">Received From:<strong> <?php 
													...
													?></strong></td>
                    <td align="left"></td>
                    <td align="left">Date Released: <?php echo date('m-d-Y', strtotime($summary[0]['tdate'])) ?></td>
                    
                </tr>
                <tr>
                	<td align="left">PO No.: <?php echo $summary[0]['po_no'] ?></td>
                    <td align="left"></td>
                ...
                <tr>
                    ...
                    <td align="left"></td>
                    <td align="left">DR NO.: <?php echo $summary[0]['receipt_num'] ?></td>
    ...
    <div id="items">
    	<div id="table">
        	<table style="width:800px; " >
                ...
                <tr>
                	<td colspan="3" id="title" align="center">&nbsp;
                    <span style="margin-right:10px; float:right">RR No.: <?php echo $summary[0]['id'] ?></span>
                    </td>
                </tr>
                ...
                <tr>
                	<td align="left">Received From:<strong> <?php 
													...
													?></strong></td>
                    <td align="left"></td>
                    <td align="left">Date: <?php echo date('m-d-Y', strtotime($summary[0]['tdate'])) ?></td>
