            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_content">                   
                                 ...
                                 <table id="datatable-responsive2" style="margin-top:10px" class="table table-striped table-bordered dt-responsive nowrap jambo_table bulk_action" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                       <?php
                                          if( !empty($released_checks) ) {
                                              foreach ($released_checks as $r){
                                          ?>
                                       <tr>
                                          
                                          <td><?php  echo date('F j, Y', strtotime($r['voucher_date'])) ?></td>
                                          <td><?php  echo $r['account_no'] ?></td>
                                          <td><?php  echo $r['name'] ?></td>
                                          <td><?php  echo $r['check_num'] ?></td>
                                          <td align="right"><?php  echo number_format($r['amount'],2) ?>&nbsp;</td>                                  
                                          <td><?php  echo $r['voucher_number'] ?></td>
                                          <td align="center"><input type="checkbox"></td>
                                          <td align="center">
                                             <a class="like" href="<?php echo HTTP_PATH ?>finance/bank_form/<?php echo $r['id'] ?>" data-toggle="modal" data-target="#modalDialog" title="Create Voucher" data-keyboard="false" data-backdrop="static">
